        ...
        <Container>
          ...
          <Navbar.Collapse>
            ...
            <Nav className="ms-auto">
              ...
              <LinkContainer to="/schedule"><Nav.Link className="mx-2">2024 Schedule</Nav.Link></LinkContainer>
              <LinkContainer to="/classlist"><Nav.Link className="mx-2">2024 Class list</Nav.Link></LinkContainer>
